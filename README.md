...
If you don't know if those directories are already created, try something like the code below—example for current user scope—, then create a module container inside.
```powershell
