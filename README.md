...
if (Test-Path -Path $HOME\Documents\PowerShell\Modules) {Write-Host "it does exist"} # $HOME is an automatic—predefined—variable that replaces "C:\Users\your-user-name"
