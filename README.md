...
Inside the folder 'snippets' you'll find functions save as PowerShell scripts (.ps1), but I strongly recommend to follow Microsoft guidelines on this matter:
