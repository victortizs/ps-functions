...
if (Test-Path -Path C:\Users\your-user-here\Documents\PowerShell\Modules) {Write-Host "it exists"} else {
Write-Host "you need to create the module path for the current user scope"
}
