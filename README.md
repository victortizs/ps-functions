...
3. Aggregate functions or any command combination to your module in your preferred editor (PowerShell ISE, Visual Studio, or VSCode). It's a nice touch to add an alias for each function you aggregate to your module, preferably using `New-Alias` instead of `Set-Alias`.
